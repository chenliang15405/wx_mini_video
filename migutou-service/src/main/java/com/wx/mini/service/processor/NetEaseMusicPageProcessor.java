...
//                    mMusicService.addComment(comment);
    ...
    public static void start(NetEaseMusicPageProcessor processor, NetEaseMusicPipeline netEaseMusicPipeline) {
...
//              .addPipeline(netEaseMusicPipeline)
    ...
    public static void main(String[] args) {
        start(new NetEaseMusicPageProcessor(),new NetEaseMusicPipeline());
    }
